...
from PySide6.QtWidgets import (
    ...
    QLineEdit, QTextEdit, QProgressBar, QHBoxLayout, QDialog,
    QMainWindow, QFileDialog, QComboBox
)
...
class DeviceScanner(QMainWindow):
    ...
    def init_ui(self):
        ...
        qdarktheme.setup_theme(custom_colors={"primary": "#fce0a7"})
    ...
    def read_settings(self):
        if os.path.exists('settings.cfg'):
            self.settings.read('settings.cfg')
            dark_mode_enabled = self.settings.getboolean('Appearance', 'DarkMode')
